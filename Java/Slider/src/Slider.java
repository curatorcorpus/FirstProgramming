...
public class Slider extends JPanel{
	...
	greenValue.addActionListener(listen);
	blueValue.addActionListener(listen);
	...
	public void actionPerformed(ActionEvent e){
	    ...
	    // set the slider to defined value in text field
	    r.setValue(Integer.parseInt(redValue.getText()));
	    g.setValue(Integer.parseInt(greenValue.getText()));
	    b.setValue(Integer.parseInt(blueValue.getText()));
	}
